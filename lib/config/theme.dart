...
class AppTheme {
  ...
  static ThemeData get darkTheme => ThemeData(
        ...
        primaryColor: primaryGreen, // Keep the same primary color for consistency
        scaffoldBackgroundColor: darkBackground,
        cardColor: darkSurface,
        dividerColor: darkDivider,
        
        // App Bar Theme - Keep the same green color for consistency
        appBarTheme: const AppBarTheme(
          backgroundColor: primaryGreen,
          foregroundColor: Colors.white,
          elevation: 0,
        ...
        // Color Scheme - Keep primary green for consistency
        ...
        // Elevated Button Theme - Keep primary green for consistency
        elevatedButtonTheme: ElevatedButtonThemeData(
          style: ElevatedButton.styleFrom(
            backgroundColor: primaryGreen,
            foregroundColor: Colors.white,
        ...
        // Switch Theme - Keep primary green for consistency
        switchTheme: SwitchThemeData(
          thumbColor: MaterialStateProperty.resolveWith((states) {
            if (states.contains(MaterialState.selected)) {
              return primaryGreen;
...
class ThemeProvider extends ChangeNotifier {
  ...
  // Force rebuild of all widgets that depend on this provider
  void forceRebuild() {
    notifyListeners();
  }
} 