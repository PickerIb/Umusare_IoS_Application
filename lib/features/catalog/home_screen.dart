          ...
          child: Column(
            children: [
              Container(
                ...
                child: Row(
                  children: [
                    Icon(Icons.shopping_cart, color: theme.colorScheme.onPrimary, size: 24),
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              ...
              right: 0,
              child: IconButton(
                icon: Icon(Icons.close, color: theme.colorScheme.onSurface.withOpacity(0.7), size: 28),
                onPressed: () => Navigator.of(context).pop(),
                tooltip: 'Close',
              ),
            ),
      ...
      appBar: AppBar(
        ...
        title: Column(
          ...
          children: [
            ...
            Text(
              '$greeting, $userName!',
              style: theme.textTheme.bodySmall?.copyWith(color: theme.appBarTheme.foregroundColor?.withOpacity(0.7) ?? Colors.white70),
            ),
          ],
        ),
        actions: [
                  ...
                  child: Row(
                    children: [
                      ...
                      Container(
                        ...
                        child: IconButton(
                          icon: Icon(Icons.tune, color: theme.colorScheme.onPrimary, size: 28),
                          onPressed: () {},
                          tooltip: 'Filter',
                        ),
                      ),
                ...
                child: SizedBox(
                  ...
                  child: ListView.separated(
                    ...
                    itemBuilder: (context, i) => ChoiceChip(
                      avatar: Icon(categories[i]['icon'] as IconData, size: 18, color: i == 0 ? theme.colorScheme.onPrimary : theme.colorScheme.primary),
                      label: Text(categories[i]['label'] as String),
                      selected: _selectedCategory == categories[i]['label'],
                      selectedColor: theme.colorScheme.primary,
                      backgroundColor: theme.cardColor,
                      labelStyle: TextStyle(
                        color: _selectedCategory == categories[i]['label'] ? theme.colorScheme.onPrimary : theme.colorScheme.onSurface,
                        fontWeight: FontWeight.bold,
                      ),
                      onSelected: (selected) {
                        if (selected) {
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          if (cartItem != null) ...[
                                            Row(
                                              children: [
                                                Icon(Icons.shopping_cart, color: theme.colorScheme.primary, size: 16),
                                                const SizedBox(width: 4),
                                                Text('In cart', style: TextStyle(color: theme.colorScheme.primary, fontSize: 12)),
                                              ],
                                            ),
                                          ],
                                        ],
